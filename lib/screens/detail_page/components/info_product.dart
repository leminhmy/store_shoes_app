...
class InfoProduct extends StatelessWidget {
  const InfoProduct({
    Key? key, required this.shoesProduct, required this.listSize, required this.listColor,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    Get.find<ShoesController>().setDefaultSizeAndColor(listSize[0],listColor[0]);
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color:  shoesController.optionSize==listSize[index]?AppColors.mainColor:AppColors.textColor,
                                  width: 2,
                                )
                            ),
                            child: Center(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: shoesController.optionColor== listColor[index]?AppColors.mainColor:Colors.transparent,
                                      width: 5,
                                    ),
