...
class AuthRepo{
  ...
  Future<Response> login(String email, String password, String tokenMessages)async{
    return await apiClient.postData(AppConstants.LOGIN_URI, {"email":email, "password":password, "token_messages": tokenMessages});
  }
